...
public class EventStorage {
    ...
    private void fillData() {
        ...
        events.add(new Event("5", "Помощь семьям в трудной жизненной ситуации", LocalDate.of(2018, JANUARY, 1), LocalDate.of(2018, JUNE, 23), "«Детские домики»", "centr.umka-deti@mail.ru", "Санкт-Петербург, Кирочная улица, д. 50А, каб. 208", new String[]{"+7 (904) 987-65-43"}, "", "http://www.umka-deti.spb.ru/", true, new String[]{"", ""}, new TypeAssistance[]{PROFESSIONAL_HELP, HELP_MONEY}, new String[]{"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEaWzS-I9eHvcLkNyyYEh6sw95Zb-ohAfzgUgMMZxOak5PkQ_bvA"}));
        events.add(new Event("6", "Танцы без границ", LocalDate.of(2018, JANUARY, 1), LocalDate.of(2018, MARCH, 9), "АНО «СИНЯЯ ПТИЦА»", "centr.umka-deti@mail.ru", "Санкт-Петербург, Кирочная улица, д. 50А, каб. 208", new String[]{"+7 (937) 312-00-00", "+7 (904) 111-11-11"}, "", "http://www.umka-deti.spb.ru/", true, new String[]{"", ""}, new TypeAssistance[]{PROFESSIONAL_HELP, HELP_MONEY}, new String[]{"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPaNf5HiEM19uR5Fgp0FfEGi_y4XjrBoEmCr5oa462uVbXGzdK"}));
        events.add(new Event("7", "Веселые выходные в больнице", LocalDate.of(2018, MARCH, 4), LocalDate.of(2018, JULY, 17), "Аппарель", "centr.umka-deti@mail.ru", "Санкт-Петербург, Кирочная улица, д. 50А, каб. 208", new String[]{"+7 (937) 312-22-01", "+7 (904) 122-13-71"}, "Участники и болельщики смогли весело и активно провести время на «Петербургском благотворительном марафоне» и при этом финансово поучаствовать в помощи детям. \n\nПри этом финансово поучаствовать в помощи детям. При этом финансово поучаствовать в помощи детям.", "http://www.umka-deti.spb.ru/", true, new String[]{"", ""}, new TypeAssistance[]{PROFESSIONAL_HELP, HELP_MONEY}, new String[]{"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRB0wE1yTqCkAacii3v0TQn66hUup71Qbfk-XheMLFRDTMPBGj4"}));
        events.add(new Event("8", "Веселый детский утренник", LocalDate.of(2018, FEBRUARY, 22), LocalDate.of(2018, APRIL, 21), "Аппарель", "centr.umka-deti@mail.ru", "Санкт-Петербург, Кирочная улица, д. 50А, каб. 208", new String[]{"+7 (937) 312-22-01", "+7 (904) 122-13-71"}, "", "http://www.umka-deti.spb.ru/", true, new String[]{"", ""}, new TypeAssistance[]{PROFESSIONAL_HELP, HELP_MONEY}, new String[]{"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKfIkC0Rixp_NGb5pTXDTJk6PCjbIUZsrTFo2dVJd1xDaHp33NJA"}));
